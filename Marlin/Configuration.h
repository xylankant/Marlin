...
#define STRING_CONFIG_H_AUTHOR "(Philip John Gorinski, derived from: thisiskeithb, Tevo Tarantula Pro)" // Who made the changes.
...
*/
#define NOZZLE_TO_PROBE_OFFSET { 0, 18, -2.03 }
